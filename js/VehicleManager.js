...
$(document).ready(() => {
    ...
    $(document).on("click", "#saveVehicle", () => {
        ...
        setTimeout(() => {
            ...
            $.ajax({
                url: "http://localhost:8080/api/v1/vehicles/save", method: "POST", headers: {
...
$(document).ready(() => {
    $(document).on("click", "#updateVehicle", () => {
        ...
        setTimeout(() => {
            ...
            $.ajax({
                url: "http://localhost:8080/api/v1/vehicles/update", method: "PUT", headers: {
                    "content-type": "application/json",
                    "Authorization": "Bearer " + JSON.parse(localStorage.getItem("adminAuthToken"))
...
$(document).ready(() => {
    $(document).on("keydown", "#vehicleBrand", (event) => {
        ...
        if (event.key === 'Enter') {
            $.ajax({
                url: "http://localhost:8080/api/v1/vehicles/getVehicleByBrand?vehicleBrand=" + $("#vehicleBrand").val(),
                method: "GET",
                headers: {
                    "Authorization": "Bearer " + JSON.parse(localStorage.getItem("adminAuthToken"))
                },
                success: (res) => {
                    ...
                    if (res.statusCode === 200 || res.statusCode === 201) {
                        ...
                        $("#isHybrid").append("<option value='" + res.data.isHybrid + "'>" + res.data.isHybrid + "</option>");
...
$(document).ready(() => {
    $(document).on("click", "#deleteVehicle", () => {
        ...
        $.ajax({
            url: "http://localhost:8080/api/v1/vehicles/delete?vehicleID=" + $("#vehicleId").val(),
            method: "DELETE",
            headers: {
                "Authorization": "Bearer " + JSON.parse(localStorage.getItem("adminAuthToken"))
            },
...
$("#tableView").on("click", () => {
    ...
    $.ajax({
        url: "http://localhost:8080/api/v1/vehicles/getAll", method: "GET", headers: {
            "Authorization": "Bearer " + JSON.parse(localStorage.getItem("adminAuthToken"))
        }, success: (res) => {
